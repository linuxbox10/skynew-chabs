#!/bin/bash
# SCRIPT: skyNEWPicks.sh
#
# Pick random entries from image lists generated by SkyQScrape.sh
# and download them as images for Sky show bouquet screen.
#
...
#          download the lists from a server. In this case script SkyScrape.sh
...
sources_maxage="720"
# UNCOMMENT TO GET IMAGE LISTS FROM SERVER INSTEAD OF FROM SCRIPT SKYSCRAPE.SH
...
piconbase="/usr/share/enigma2/skyNEW/SkyIcons/picons-base/"
piconpath="/usr/share/enigma2/skyNEW/SkyIcons/picons/"
screenpath="/usr/share/enigma2/skyNEW/SkyIcons"
scraper="/usr/script/SkyScrape.sh"
...
for image_no in 1 2 3 4 5 7; do
  # Set the toppicks image size and define allowed categories
  case ${image_no} in
    1) resize="w=378&h=244&mode=crop"; min_category="1"; max_category="1" ;;
    2) resize="w=183&h=244&mode=crop";  min_category="3"; max_category="3" ;;
    3) resize="w=183&h=116&mode=crop"; min_category="5"; max_category="5" ;;
    4) resize="w=183&h=116&mode=crop"; min_category="7"; max_category="7" ;;
    5) resize="w=183&h=116&mode=crop"; min_category="6"; max_category="6" ;;
    7) resize="w=183&h=244&mode=crop";  min_category="2"; max_category="2" ;;
  esac
